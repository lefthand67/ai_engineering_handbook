...
**Шаг 3:** Назначение клавиш. Назначьте ключевые команды на ваш Leader-key (например, `<Space>oc` для Чата, `<Space>oe` для Редактирования выделенного кода).

**Шаг 4:** Умное принятие решений. Верните своей клавише `<Tab>` стандартное поведение и назначьте принятие подсказок ИИ на интуитивные клавиши, такие как `Ctrl+y` (принять всё), `Ctrl+j` (принять строку) и `Ctrl+l` (принять слово).
