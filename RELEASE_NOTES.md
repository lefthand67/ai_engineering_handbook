...
* **Aider Handout Expanded:** "Aider Integration with LLMs Using API Keys" workflow introduced in [Aider Commands Handout](/ai_agents/guides/aider/aider_commands_handout.ipynb).
